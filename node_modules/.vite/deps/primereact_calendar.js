...
import {
  ...
  IconBase,
  Ripple
} from "./chunk-B4TXERV3.js";
import {
  InputText
} from "./chunk-2T7JCBXD.js";
import {
  ComponentBase,
  DomHandler,
  EventBus,
...
var ChevronLeftIcon = React3.memo(React3.forwardRef(function(inProps, ref) {
  var pti = IconBase.getPTI(inProps);
...
var ChevronUpIcon = React5.memo(React5.forwardRef(function(inProps, ref) {
  var pti = IconBase.getPTI(inProps);
...
var CSSTransition = function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return import_react3.default.createElement(Transition_default, _extends6({}, props, {
...
var CSSTransition2 = React12.forwardRef(function(inProps, ref) {
...
var CalendarPanel = React13.forwardRef(function(props, ref) {
  var cx = props.cx;
  ...
  return props.inline ? element : React13.createElement(Portal, {
    element,
...
var Calendar = React13.memo(React13.forwardRef(function(inProps, ref) {
  var mergeProps = useMergeProps();
  var context = React13.useContext(PrimeReactContext);
  var props = CalendarBase.getProps(inProps, context);
  var _React$useState = React13.useState(false), _React$useState2 = _slicedToArray(_React$useState, 2), focusedState = _React$useState2[0], setFocusedState = _React$useState2[1];
  var _React$useState3 = React13.useState(false), _React$useState4 = _slicedToArray(_React$useState3, 2), overlayVisibleState = _React$useState4[0], setOverlayVisibleState = _React$useState4[1];
  var _React$useState5 = React13.useState(null), _React$useState6 = _slicedToArray(_React$useState5, 2), viewDateState = _React$useState6[0], setViewDateState = _React$useState6[1];
  var _React$useState7 = React13.useState(props.id), _React$useState8 = _slicedToArray(_React$useState7, 2), idState = _React$useState8[0], setIdState = _React$useState8[1];
  var metaData = {
    props,
    state: {
  ...
  var navigation = React13.useRef(null);
  var ignoreFocusFunctionality = React13.useRef(false);
  var timePickerTimer = React13.useRef(null);
  var viewStateChanged = React13.useRef(false);
  var touchUIMask = React13.useRef(null);
  var overlayEventListener = React13.useRef(null);
  var touchUIMaskClickListener = React13.useRef(null);
  var isOverlayClicked = React13.useRef(false);
  var previousButton = React13.useRef(false);
  var nextButton = React13.useRef(false);
  var viewChangedWithKeyDown = React13.useRef(false);
  var onChangeRef = React13.useRef(null);
  var isClearClicked = React13.useRef(false);
  var _React$useState9 = React13.useState("date"), _React$useState10 = _slicedToArray(_React$useState9, 2), currentView = _React$useState10[0], setCurrentView = _React$useState10[1];
  var _React$useState11 = React13.useState(null), _React$useState12 = _slicedToArray(_React$useState11, 2), currentMonth = _React$useState12[0], setCurrentMonth = _React$useState12[1];
  var _React$useState13 = React13.useState(null), _React$useState14 = _slicedToArray(_React$useState13, 2), currentYear = _React$useState14[0], setCurrentYear = _React$useState14[1];
  var _React$useState15 = React13.useState([]), _React$useState16 = _slicedToArray(_React$useState15, 2), yearOptions = _React$useState16[0], setYearOptions = _React$useState16[1];
  ...
  var createBackwardNavigator = function createBackwardNavigator2(isVisible) {
    ...
    var icon = props.prevIcon || React13.createElement(ChevronLeftIcon, previousIconProps);
    ...
    return React13.createElement("button", _extends7({
      ref: previousButton
    }, previousButtonProps), backwardNavigatorIcon, React13.createElement(Ripple, null));
  };
  var createForwardNavigator = function createForwardNavigator2(isVisible) {
    ...
    var icon = props.nextIcon || React13.createElement(ChevronRightIcon, nextIconProps);
    ...
    return React13.createElement("button", _extends7({
      ref: nextButton
    }, nextButtonProps), forwardNavigatorIcon, React13.createElement(Ripple, null));
  };
  ...
  var createTitleMonthElement = function createTitleMonthElement2(month2, monthIndex) {
    ...
    if (renderMonthsNavigator(monthIndex)) {
      ...
      var _content = React13.createElement("select", selectProps, displayedMonthOptions.map(function(option) {
        var optionProps = mergeProps({
          value: option.value
        }, ptm("option"));
        return React13.createElement("option", _extends7({}, optionProps, {
          key: option.label
        }), option.label);
      }));
    ...
    return currentView === "date" && React13.createElement("button", monthTitleProps, monthNames[month2]);
  };
  var createTitleYearElement = function createTitleYearElement2(metaYear) {
    ...
    if (props.yearNavigator) {
      ...
      var _content2 = React13.createElement("select", selectProps, displayedYearNames.map(function(year2) {
        var optionProps = mergeProps({
          value: year2
        }, ptm("option"));
        return React13.createElement("option", _extends7({}, optionProps, {
    ...
    return currentView !== "year" && React13.createElement("button", yearTitleProps, displayYear);
  };
  var createTitleDecadeElement = function createTitleDecadeElement2() {
    ...
    if (currentView === "year") {
      ...
      return React13.createElement("span", decadeTitleProps, props.decadeTemplate ? props.decadeTemplate(years) : React13.createElement("span", decadeTitleTextProps, "".concat(yearPickerValues()[0], " - ").concat(yearPickerValues()[yearPickerValues().length - 1])));
    }
    return null;
  };
  var createTitle = function createTitle2(monthMetaData, index) {
    ...
    return React13.createElement("div", titleProps, showMonthAfterYear ? year2 : month2, showMonthAfterYear ? month2 : year2, decade);
  };
  var createDayNames = function createDayNames2(weekDays) {
    ...
    var dayNames = weekDays.map(function(weekDay, index) {
      return React13.createElement("th", _extends7({}, tableHeaderCellProps, {
        key: "".concat(weekDay, "-").concat(index)
      }), React13.createElement("span", weekDayProps, weekDay));
    });
    if (props.showWeek) {
      ...
      var weekHeader = React13.createElement("th", _extends7({}, weekHeaderProps, {
        key: "wn"
      }), React13.createElement("span", weekLabel, localeOption("weekHeader", props.locale)));
  ...
  var createDateCellContent = function createDateCellContent2(date, className, groupIndex) {
    ...
    return React13.createElement("span", dayLabelProps, content2, selected && React13.createElement("div", {
      "aria-live": "polite",
  ...
  var createWeek = function createWeek2(weekDates, weekNumber, groupIndex) {
    var week = weekDates.map(function(date) {
      ...
      return React13.createElement("td", _extends7({}, dayProps, {
        key: date.day
      }), content2);
    });
    if (props.showWeek) {
      ...
      var weekNumberCell = React13.createElement("td", _extends7({}, weekNumberProps, {
        key: "wn" + weekNumber
      }), React13.createElement("span", weekLabelContainerProps, weekNumber));
  ...
  var createDates = function createDates2(monthMetaData, groupIndex) {
    ...
    return monthMetaData.dates.map(function(weekDates, index) {
      return React13.createElement("tr", _extends7({}, tableBodyRowProps, {
        key: index
  ...
  var createDateViewGrid = function createDateViewGrid2(monthMetaData, weekDays, groupIndex) {
    ...
    return currentView === "date" && React13.createElement("div", containerProps, React13.createElement("table", tableProps, React13.createElement("thead", tableHeaderProps, React13.createElement("tr", tableHeaderRowProps, dayNames)), React13.createElement("tbody", tableBodyProps, dates)));
  };
  var createMonth = function createMonth2(monthMetaData, index) {
    ...
    return React13.createElement("div", _extends7({}, groupProps, {
      key: monthKey
    }), React13.createElement("div", headerProps, header, backwardNavigator, title, forwardNavigator), dateViewGrid);
  };
  var createMonths = function createMonths2(monthsMetaData) {
    ...
    return React13.createElement("div", groupContainerProps, groups);
  };
  ...
  var createMonthYearView = function createMonthYearView2() {
    ...
    return React13.createElement(React13.Fragment, null, React13.createElement("div", groupContainerProps, React13.createElement("div", groupProps, React13.createElement("div", headerProps, backwardNavigator, React13.createElement("div", titleProps, yearElement, decade), forwardNavigator))));
  };
  ...
  var incrementIcon = IconUtils.getJSXIcon(props.incrementIcon || React13.createElement(ChevronUpIcon, incrementIconProps), _objectSpread2({}, incrementIconProps), {
    props
  });
  var decrementIcon = IconUtils.getJSXIcon(props.decrementIcon || React13.createElement(ChevronDownIcon, decrementIconProps), _objectSpread2({}, decrementIconProps), {
    props
  });
  var createHourPicker = function createHourPicker2() {
    ...
    return React13.createElement("div", hourPickerProps, React13.createElement("button", incrementButtonProps, incrementIcon, React13.createElement(Ripple, null)), React13.createElement("span", hourProps, hourDisplay), React13.createElement("button", decrementButtonProps, decrementIcon, React13.createElement(Ripple, null)));
  };
  var createMinutePicker = function createMinutePicker2() {
    ...
    return React13.createElement("div", minutePickerProps, React13.createElement("button", incrementButtonProps, incrementIcon, React13.createElement(Ripple, null)), React13.createElement("span", minuteProps, minuteDisplay), React13.createElement("button", decrementButtonProps, decrementIcon, React13.createElement(Ripple, null)));
  };
  var createSecondPicker = function createSecondPicker2() {
    if (props.showSeconds) {
      ...
      return React13.createElement("div", secondPickerProps, React13.createElement("button", incrementButtonProps, incrementIcon, React13.createElement(Ripple, null)), React13.createElement("span", secondProps, secondDisplay), React13.createElement("button", decrementButtonProps, decrementIcon, React13.createElement(Ripple, null)));
    }
    return null;
  };
  var createMiliSecondPicker = function createMiliSecondPicker2() {
    if (props.showMillisec) {
      ...
      return React13.createElement("div", millisecondPickerProps, React13.createElement("button", incrementButtonProps, incrementIcon, React13.createElement(Ripple, null)), React13.createElement("span", millisecondProps, millisecondDisplay), React13.createElement("button", decrementButtonProps, decrementIcon, React13.createElement(Ripple, null)));
    }
    return null;
  };
  var createAmPmPicker = function createAmPmPicker2() {
    if (props.hourFormat === "12") {
      ...
      return React13.createElement("div", ampmPickerProps, React13.createElement("button", incrementButtonProps, incrementIcon, React13.createElement(Ripple, null)), React13.createElement("span", ampmProps, display), React13.createElement("button", decrementButtonProps, decrementIcon, React13.createElement(Ripple, null)));
    }
    return null;
  };
  var createSeparator = function createSeparator2(separator) {
    ...
    return React13.createElement("div", separatorContainerProps, React13.createElement("span", separatorProps, separator));
  };
  var createTimePicker = function createTimePicker2() {
    if ((props.showTime || props.timeOnly) && currentView === "date") {
      ...
      return React13.createElement("div", timePickerProps, createHourPicker(), createSeparator(":"), createMinutePicker(), props.showSeconds && createSeparator(":"), createSecondPicker(), props.showMillisec && createSeparator("."), createMiliSecondPicker(), props.hourFormat === "12" && createSeparator(":"), createAmPmPicker());
    }
    return null;
  };
  var createInputElement = function createInputElement2() {
    if (!props.inline) {
      return React13.createElement(InputText, {
        ref: inputRef,
        id: props.inputId,
        name: props.name,
        type: "text",
  ...
  var createButton = function createButton2() {
    if (props.showIcon) {
      return React13.createElement(Button, {
        type: "button",
        icon: props.icon || React13.createElement(CalendarIcon, null),
  ...
  var createContent = function createContent2() {
    ...
    if (props.iconPos === "left") {
      return React13.createElement(React13.Fragment, null, button, input2);
    }
    return React13.createElement(React13.Fragment, null, input2, button);
  };
  var createButtonBar = function createButtonBar2() {
    if (props.showButtonBar) {
      ...
      return React13.createElement("div", buttonbarProps, React13.createElement(Button, {
        type: "button",
  ...
  var createFooter = function createFooter2() {
    if (props.footerTemplate) {
      ...
      return React13.createElement("div", footerProps, _content3);
    }
    return null;
  };
  var createMonthPicker = function createMonthPicker2() {
    if (currentView === "month") {
      ...
      return React13.createElement("div", monthPickerProps, monthPickerValues().map(function(m, i) {
        ...
        return React13.createElement("span", _extends7({}, monthProps, {
          key: "month".concat(i + 1)
        }), m, selected && React13.createElement("div", {
          "aria-live": "polite",
          className: "p-hidden-accessible",
          "data-p-hidden-accessible": true,
          pt: ptm("hiddenMonth")
  ...
  var createYearPicker = function createYearPicker2() {
    if (currentView === "year") {
      ...
      return React13.createElement("div", yearPickerProps, yearPickerValues().map(function(y, i) {
        ...
        return React13.createElement("span", _extends7({}, yearProps, {
          key: "year".concat(i + 1)
        }), y, selected && React13.createElement("div", {
          "aria-live": "polite",
          className: "p-hidden-accessible",
          "data-p-hidden-accessible": true,
          pt: ptm("hiddenYear")
  ...
  return React13.createElement("span", _extends7({
    ref: elementRef
  }, rootProps), content, React13.createElement(CalendarPanel, {
    hostName: "Calendar",
    id: panelId,
    locale: props.locale,
    ref: overlayRef,
