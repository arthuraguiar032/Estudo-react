...
var ListBoxHeader = React.memo(function(props) {
  ...
  var createHeader = function createHeader2() {
    ...
    var content2 = React.createElement("div", filterContainerProps, React.createElement(InputText, _extends({
      type: "text",
      value: props.filter,
      onChange: onFilter,
    ...
    return React.createElement("div", headerProps, content2);
  };
  var content = createHeader();
  return React.createElement(React.Fragment, null, content);
});
ListBoxHeader.displayName = "ListBoxHeader";
var ListBoxItem = React.memo(function(props) {
...
var ListBox = React.memo(React.forwardRef(function(inProps, ref) {
  var mergeProps = useMergeProps();
  ...
  var createHeader = function createHeader2() {
    return props.filter ? React.createElement(ListBoxHeader, {
      hostName: "ListBox",
  ...
  var createGroupChildren = function createGroupChildren2(optionGroup, style) {
    ...
    return groupChildren.map(function(option, j) {
      ...
      return React.createElement(ListBoxItem, {
        id: id.current + "_" + j,
        hostName: "ListBox",
        optionKey,
        key: optionKey,
  ...
  var createList = function createList2() {
    ...
    return React.createElement("ul", listProps, items);
  };
  ...
  return React.createElement(React.Fragment, null, React.createElement("div", rootProps, React.createElement("span", hiddenFirstElement), header, React.createElement("div", wrapperProps, list2), React.createElement("span", hiddenLastElement)), hasTooltip && React.createElement(Tooltip, _extends({
    target: elementRef,
