...
import {
  PlusIcon
} from "./chunk-4QV4ABMT.js";
import {
  CheckIcon,
  TimesIcon
} from "./chunk-LRFVG5CF.js";
import {
  CSSTransition,
  TransitionGroup_default
} from "./chunk-TFNMGUJR.js";
import {
  Button
} from "./chunk-D3ZXUTO4.js";
import {
  IconBase,
  Ripple
} from "./chunk-77SPMYUZ.js";
import "./chunk-7LLECWEP.js";
import {
  ComponentBase,
  DomHandler,
  IconUtils,
  ...
  useMergeProps,
  useTimeout
} from "./chunk-GPY6NEG5.js";
import "./chunk-X6ADV7NM.js";
import {
  require_react
...
var UIMessage = React5.memo(React5.forwardRef(function(props, ref) {
  ...
  var createCloseIcon = function createCloseIcon2() {
    if (closable !== false) {
      ...
      return React5.createElement("button", buttonProps, _closeIcon2, React5.createElement(Ripple, null));
    }
    return null;
  };
  var createMessage = function createMessage2() {
    if (props.message) {
      ...
      return content || React5.createElement(React5.Fragment, null, iconContent, React5.createElement("span", summaryProps, summary), React5.createElement("span", detailProps, detail));
    }
    return null;
  };
  ...
  return React5.createElement("div", rootProps, React5.createElement("div", wrapperProps, message, closeIcon));
}));
...
var messageIdx = 0;
var Messages = React5.memo(React5.forwardRef(function(inProps, ref) {
  var mergeProps = useMergeProps();
  ...
  return React5.createElement("div", _extends5({
    ref: elementRef
  }, rootProps), React5.createElement(TransitionGroup_default, null, messagesState && messagesState.map(function(message, index) {
    var messageRef = React5.createRef();
    return React5.createElement(CSSTransition, _extends5({
      nodeRef: messageRef,
      key: message._pId
    }, transitionProps), React5.createElement(UIMessage, {
      hostName: "Messages",
      ref: messageRef,
      message,
...
var ProgressBar = React6.memo(React6.forwardRef(function(inProps, ref) {
  var mergeProps = useMergeProps();
  ...
  var createDeterminate = function createDeterminate2() {
    ...
    return React6.createElement("div", _extends6({
      id: props.id,
      ref: elementRef
    }, rootProps), React6.createElement("div", valueProps, label != null && React6.createElement("div", labelProps, label)));
  };
  var createIndeterminate = function createIndeterminate2() {
    ...
    return React6.createElement("div", _extends6({
      id: props.id,
      ref: elementRef
    }, rootProps), React6.createElement("div", containerProps, React6.createElement("div", valueProps)));
  };
...
var Badge = React7.memo(React7.forwardRef(function(inProps, ref) {
  var mergeProps = useMergeProps();
  ...
  return React7.createElement("span", rootProps, props.value);
}));
...
var FileUpload = React7.memo(React7.forwardRef(function(inProps, ref) {
  var mergeProps = useMergeProps();
  var context = React7.useContext(PrimeReactContext);
  var props = FileUploadBase.getProps(inProps, context);
  var _React$useState = React7.useState([]), _React$useState2 = _slicedToArray2(_React$useState, 2), uploadedFilesState = _React$useState2[0], setUploadedFilesState = _React$useState2[1];
  var _React$useState3 = React7.useState([]), _React$useState4 = _slicedToArray2(_React$useState3, 2), filesState = _React$useState4[0], setFilesState = _React$useState4[1];
  var _React$useState5 = React7.useState(0), _React$useState6 = _slicedToArray2(_React$useState5, 2), progressState = _React$useState6[0], setProgressState = _React$useState6[1];
  var _React$useState7 = React7.useState(false), _React$useState8 = _slicedToArray2(_React$useState7, 2), focusedState = _React$useState8[0], setFocusedState = _React$useState8[1];
  var _React$useState9 = React7.useState(false), _React$useState10 = _slicedToArray2(_React$useState9, 2), uploadingState = _React$useState10[0], setUploadingState = _React$useState10[1];
  var metaData = {
    props,
    state: {
  ...
  var fileInputRef = React7.useRef(null);
  var messagesRef = React7.useRef(null);
  var contentRef = React7.useRef(null);
  var uploadedFileCount = React7.useRef(0);
  ...
  var createChooseButton = function createChooseButton2() {
    ...
    var label = iconOnly ? React7.createElement("span", _extends7({}, chooseButtonLabelProps, {
      dangerouslySetInnerHTML: {
        __html: "&nbsp;"
      }
    })) : React7.createElement("span", chooseButtonLabelProps, chooseButtonLabel);
    ...
    var input = React7.createElement("input", inputProps);
    ...
    var icon = _icon || React7.createElement(PlusIcon, chooseIconProps);
    ...
    return React7.createElement("span", chooseButtonProps, input, chooseIcon2, label, React7.createElement(Ripple, null));
  };
  ...
  var createFile = function createFile2(file, index, badgeOptions) {
    ...
    var preview = isImage(file) ? React7.createElement("img", _extends7({}, thumbnailProps, {
      alt: file.name
    })) : null;
    ...
    var fileName = React7.createElement("div", fileNameProps, file.name);
    var size = React7.createElement("div", fileSizeProps, formatSize(file.size));
    var contentBody = React7.createElement("div", detailsProps, React7.createElement("div", fileNameProps, " ", file.name), React7.createElement("span", fileSizeProps, formatSize(file.size)), React7.createElement(Badge, {
    ...
    var removeButton = React7.createElement("div", actionsProps, React7.createElement(Button, {
      type: "button",
      icon: props.removeIcon || React7.createElement(TimesIcon, null),
      text: true,
      rounded: true,
      severity: "danger",
    ...
    var content = React7.createElement(React7.Fragment, null, preview, contentBody, removeButton);
    ...
    return React7.createElement("div", fileProps, content);
  };
  var createFiles = function createFiles2() {
    ...
    return React7.createElement("div", null, content);
  };
  ...
  var createProgressBarContent = function createProgressBarContent2() {
    ...
    return React7.createElement(ProgressBar, {
      value: progressState,
      showValue: false,
      pt: ptm("progressbar"),
      __parentMetadata: {
  ...
  var createAdvanced = function createAdvanced2() {
    ...
    if (!props.auto) {
      ...
      var uploadIcon2 = IconUtils.getJSXIcon(uploadOptions.icon || React7.createElement(UploadIcon, uploadIconProps), _objectSpread3({}, uploadIconProps), {
        props
      });
      ...
      var cancelIcon2 = IconUtils.getJSXIcon(cancelOptions.icon || React7.createElement(TimesIcon, cancelIconProps), _objectSpread3({}, cancelIconProps), {
        props
      });
      uploadButton = React7.createElement(Button, {
        type: "button",
        label: uploadLabel,
        "aria-hidden": "true",
        icon: uploadIcon2,
      ...
      cancelButton = React7.createElement(Button, {
        type: "button",
        label: cancelLabel,
        "aria-hidden": "true",
        icon: cancelIcon2,
    ...
    var header = React7.createElement("div", buttonbarProps, chooseButton2, uploadButton, cancelButton);
    ...
    return React7.createElement("div", rootProps, header, React7.createElement("div", contentProps, progressBar, React7.createElement(Messages, {
      ref: messagesRef,
      __parentMetadata: {
        parent: metaData
      }
  ...
  var createBasic = function createBasic2() {
    ...
    var chooseLabel = chooseOptions.iconOnly ? React7.createElement("span", _extends7({}, labelProps, {
      dangerouslySetInnerHTML: {
        __html: "&nbsp;"
      }
    })) : React7.createElement("span", labelProps, chooseButtonLabel);
    var label = props.auto ? chooseLabel : React7.createElement("span", labelProps, hasFiles ? filesState[0].name : chooseLabel);
    var chooseIconProps = mergeProps({
      className: cx("chooseIcon", {
        iconOnly: chooseOptions.iconOnly
      })
    }, ptm("chooseIcon"));
    var icon = chooseOptions.icon ? chooseOptions.icon : !chooseOptions.icon && (!hasFiles || props.auto) ? React7.createElement(PlusIcon, chooseIconProps) : !chooseOptions.icon && hasFiles && !props.auto && React7.createElement(UploadIcon, chooseIconProps);
    var chooseIcon2 = IconUtils.getJSXIcon(icon, _objectSpread3({}, chooseIconProps), {
      props,
      hasFiles
    });
    ...
    var input = !hasFiles && React7.createElement("input", inputProps);
    var rootProps = mergeProps({
      className: classNames(props.className, cx("root")),
      style: props.style
    }, FileUploadBase.getOtherProps(props), ptm("root"));
    ...
    return React7.createElement("div", rootProps, React7.createElement(Messages, {
      ref: messagesRef,
      pt: ptm("message"),
      __parentMetadata: {
        parent: metaData
      }
    }), React7.createElement("span", basicButtonProps, chooseIcon2, label, input, React7.createElement(Ripple, null)));
  };
  if (props.mode === "advanced") {
